$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*Hello,My name is Polly Pang a front-end developer</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*Mainly handling design websites and user experience</div>",2000);
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	c.load("<p><div class='bef_comment writecode'>/**</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*Let'S GO! With my Animation resume</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<p><div class='bef_comment writecode'>/**</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*OH~~Right now you may feel boring with this layout...</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*Let's Change!</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='code writecode'>}</div></p>");
	c.load("<p><div class='bef_comment writecode'>/**</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*Lets change the font color</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='code writecode'>}</div></p>");
	c.load("<p><div class='bef_comment writecode'>/**</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*emm...the page looks nicer now...</div>");
	
	c.load("<div class='bef_comment writecode'>&nbsp;*Let create a new window!!</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='code writecode'>}</div></p>");
	c.load("<p><div class='bef_comment writecode'>/**</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*OK，let's do some transform</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*Now LETS DO some 3D Animation</div>");
	...
	c.load("<div class='code writecode'>&nbsp;<span class='key'>max-height</span>: <span class='value'>94.5%</span>;</div>");
  	...
  	c.load("<div class='code writecode'>}</div></p>");
  	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*RIGHT NOW START MY RESUME</div>");
	c.load("<div class='comment writecode'>&nbsp;*It's not only fancy colors.</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	var w = new Coder("md");
	w.load("<h1 class='writecode'>Resume</h1>");
	w.load("<p><div class='writecode'>Polly Pang</div>");
	w.load("<div class='writecode'>Front-end developer</div</div>");

	w.load("<h1 class='writecode'>Contact ME</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:miru11104627@gmail.com</li>");
	w.load("<li class='writecode'>linkedin:<a href='https://www.linkedin.com/in/fan-pang-8b061715b/'>www.linkedin.com/in/fan-pang-8b061715b</a></li>");

	w.load("<h1 class='writecode'>SKILLS</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>Web Application Skills:HTML5, CSS3, Javascript ES5/6, Typescript, JSON, Restful API, Jquery, SEO, Google Analytics, Node.js</li>");
	w.load("<li class='writecode'>Web Framework: React, redux, Django, jQuery, Bootstrap 4, AngularJS, Shopifiy </li>");
	w.load("<li class='writecode'>Programming Skills:Python, php,Java,C</li>");
	w.load("<li class='writecode'>Database Skills:SQL, MySQL, PostgreSQL</li>");
	w.load("<li class='writecode'>Team tools:Git/SVN, Docker, Jira, Trello(domino)</li>");
	w.load("<li class='writecode'>Software:	Sketch, Photoshop, Ae, Illustrator</li>");
	w.load("</ul>");
	
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*Maybe you are not satisfy with the layout...</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='code writecode'>}</div></p>");
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*ALL right let'S GO!</div>");
	
	c.load("<div class='comment writecode'>&nbsp;*Let me make the resume move~~~~~</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
	...
	c.load("<div class='code writecode'>}</div></p>");
	c.load("<p><div class='comment writecode'>/**</div>");
	c.load("<div class='comment writecode'>&nbsp;*It is time to say good bye!</div>");
	c.load("<div class='comment writecode'>&nbsp;*Thank U！</div>");
	c.load("<div class='comment writecode'>&nbsp;*/</div></p>");
